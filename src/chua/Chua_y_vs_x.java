...
public class Chua_y_vs_x extends JDialog
{
    ...
    public Chua_y_vs_x(Image img)
    {
        ...
        btnFitLinear.addActionListener(new AbstractAction()
        {
            public void actionPerformed(ActionEvent event)
            {
                ...
                setTitle(" Chua System - phase y' vs. x' (" + String.format("%.4f", Main.project_phi) + ", " + String.format("%.4f", Main.project_theta) + ", " + Double.toString(Main.project_psi) + ") (" + String.format(" %.7f", Main.final_delt) + ")");
            }
        });
    ...
    protected static String fit_linear_response()
    {
        ...
        double[] xfer = new double[] {674880000, 99.994, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990238766388633E-5, -0.07948591838782587, -0.11760657795060518, -0.40971090508792746};
        //double[] xfer = new double[] {564960000, 99.992, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990234081159618E-5, -0.07947483489505322, -0.11760925612278239, -0.4097508289422011};

        //double[] xfer = new double[] {120960000, 99.9948, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990240566748076E-5, -0.05156625901609992, -0.11608886935647862, -0.8630109242590116};
        //double[] xfer = new double[] {56160000, 99.9948, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.99024063585996E-5, -0.24418173123768702, 0.018240032410561963, 4.6235659980967165};

        //double[] xfer = new double[] {115200000, 99.9948, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990240639771866E-5, 0.004748943164998271, -0.11751504924856905, -0.40459767274819286};
        //double[] xfer = new double[] {115200000, 99.9948, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990240639771866E-5, -0.07949006635805343, -0.11760549635768505, -0.4096995501725295};
        //double[] xfer = new double[]  {1026720000, 99.978, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990201291046956E-5, -0.07947902946619631, -0.11763086680493401, -0.4086791243052849};
        //double[] xfer = new double[] {115200000, 99.9948, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990240639771866E-5,  0.07949006635805343,  0.11760549635768505,  0.4096995501725295};
        //double[] xfer = new double[] {497280000, 99.98, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990205973602354E-5, -0.07941336310687076, -0.1176255117352138, -0.40990657106756856};
        //double[] xfer = new double[] {295680000, 99.983, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990213000588725E-5, -0.07943002978174979, -0.1176214908427133, -0.409846500104863};
        //double[] xfer = new double[] {295680000, 99.983, 1499.25037, -0.51325, -1.0, 0.144, 240000, -6.990213000588725E-7, -0.07943002978174979, -0.1176214908427133, -0.409846500104863};
        //double[] xfer = new double[] {73920000, 99.986, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990220027396315E-5, -0.07944157457516013, -0.11761729444366137, -0.4098706209914675};
        //double[] xfer = new double[] {73920000, 99.986, 1499.25037, -0.51325, -1.0, 0.144, 240000, -6.990220027396315E-7, -0.07944157457516013, -0.11761729444366137, -0.4098706209914675};
        //double[] xfer = new double[] {266400000, 99.988, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990224712095541E-5, -0.07945266611931306, -0.11761461495767934, -0.4098306840833202};
        //double[] xfer = new double[] {266400000, 99.988, 1499.25037, -0.51325, -1.0, 0.144, 240000, -6.990224712095541E-7, -0.07945266611931306, -0.11761461495767934, -0.4098306840833202};
        //double[] xfer = new double[] {432000000, 99.990, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990229396625384E-5, -0.07946375192207007, -0.11761193555524098, -0.409790754230023};
        //double[] xfer = new double[] {432000000, 99.990, 1499.25037, -0.51325, -1.0, 0.144, 24000, -6.990229396625384E-6, -0.07946375192207007, -0.11761193555524098, -0.409790754230023};
        //double[] xfer = new double[] {432000000, 99.990, 1499.25037, -0.51325, -1.0, 0.144, 240000, -6.990229396625384E-7, -0.07946375192207007, -0.11761193555524098, -0.409790754230023};
        //double[] xfer = new double[] {564960000, 99.992, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990234081159618E-5, -0.07947483489505322, -0.11760925612278239, -0.4097508289422011};
        //double[] xfer = new double[] {564960000, 99.992, 1499.25037, -0.51325, -1.0, 0.144, 240000, -6.990234081159618E-7, -0.07947483489505322, -0.11760925612278239, -0.4097508289422011};
        //double[] xfer = new double[] {674880000, 99.994, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990238766388633E-5, -0.07948591838782587, -0.11760657795060518, -0.40971090508792746};
        //double[] xfer = new double[] {674880000, 99.994, 1499.25037, -0.51325, -1.0, 0.144, 24000, -6.990238766388633E-6, -0.07948591838782587, -0.11760657795060518, -0.40971090508792746};
        //double[] xfer = new double[] {674880000, 99.994, 1499.25037, -0.51325, -1.0, 0.144, 240000, -6.990238766388633E-7, -0.07948591838782587, -0.11760657795060518, -0.40971090508792746};
        //double[] xfer = new double[] {157438200, 99.994, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990238765909137E-5, 0.26027549406337325, 0.012401359261099492, -4.637620120153234};
        //double[] xfer = new double[] {157438600, 99.994, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990238765909137E-5, 0.13121720447998847, 0.10767537420518608, -1.8107041690565158};
        //double[] xfer = new double[] {762720000, 99.9944, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990239703156424E-5, -0.07948813533670479, -0.11760604163576291, -0.4097029185242021};
        ...
        //double[] xfer = new double[] {135360000, 99.995, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990241108154909E-5, -0.08045376058819491, -0.11763810220882447, -0.3937922130263806};
        ...
        //double[] xfer = new double[] {121440000, 99.994, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990238765861372E-5, -0.18768009415178913, -0.11190356267981405, 1.4850779591762608};
        ...
        //double[] xfer = new double[] {1200000000, 99.98, 1499.25037, -0.51325, -1.0, 0.144, 9600, -1.7475514927803147E-5, 0.1533089568330305, -0.1022899360504326, -2.434923431735062};
        ...
        //double[] xfer = new double[] {242398700, 99.986, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990220027466412E-5, 0.05926189365055824, 0.1165021867799945, -0.5880480000689512};
        //double[] xfer = new double[] {748319900, 99.98, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990205973185646E-5, -0.20140905003942053, 0.09219319097836165, 3.0282616914862044};

        //double[] xfer = new double[] {138240000, 99.9948, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990240639774981E-5, -0.0795615211221616, -0.11760798324090092, -0.4085195529702701};
        //double[] xfer = new double[] {122400000, 99.9948, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.99024064001414E-5, 0.004697056930110323, -0.11751631248834267, -0.40382553775191204};
        //double[] xfer = new double[] {1078080000, 99.978, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.9902012894013E-5, -0.07750375328500131, -0.11755946061607105, -0.4412611409370959};
        // init 7 scatter Jan 7, 2025
        //double[] xfer = new double[] {1078080000, 99.978, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.9902012894013E-5, -0.077503694, -0.117559428, -0.441261135};
        //double[] xfer = new double[] {1078080000, 99.98, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990205973185646E-5, -0.077512444, -0.117556636, -0.441261659};
        //double[] xfer = new double[] {1078080000, 99.983, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990213000588725E-5, -0.077525255, -0.117552519, -0.441262428};
        //double[] xfer = new double[] {1078080000, 99.986, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990220027396315E-5, -0.077538221, -0.117548356, -0.441263205};
        //double[] xfer = new double[] {1078080000, 99.99, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990229396625384E-5, -0.07755548, -0.117542818, -0.44126424};
        //double[] xfer = new double[] {1078080000, 99.994, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990238766388633E-5, -0.077572714, -0.117537279, -0.441265273};
        //double[] xfer = new double[] {1078080000, 99.9944, 1499.25037, -0.51325, -1.0, 0.144, 2400, -6.990239702576763E-5, -0.077574437, -0.117536726, -0.441265377};
...
// Normally invert time
        ...
        for (int i = 0; i < 3; i++)         // initiallize dx/du, dy/du, or dz/du
        {
            ...
            //System.out.println("init ," + i + ", " + pt6[3] + ", " + pt6[4] + ", " + pt6[5]);
            //System.out.println(i + ", 0" + ", " + pt6[0] + ", " + pt6[1] + ", " + pt6[2] + ", " + pt6[3] + ", " + pt6[4] + ", " + pt6[5]);
            for (int k = 0; k < Main.final_Period; k++)                     // loop through one cycle
            {
                Main.runge_kutta_chua6_ddu3(pt6, Main.final_delt);
                //if (k < 2400)
                //    System.out.println(i + ", " + (k + 1) + ", " + pt6[0] + ", " + pt6[1] + ", " + pt6[2] + ", " + pt6[3] + ", " + pt6[4] + ", " + pt6[5]);
                //if (i < 2)                                                   // temporary code
                //{
                //    Main.project_phi = Main.calc_phi(pt6[0], pt6[1], pt6[2]);
                //    Main.project_theta = Main.calc_theta(pt6[0], pt6[1], pt6[2]);
                //    Point2D.Double pt2temp = Main.project_2D(pt6[3], pt6[4], pt6[5]);               // temporary code
                //    System.out.println((k + 1) + ", " + pt6[0] + ", " + pt6[1] + ", " + pt6[2] + ", " + pt2temp.x + ", " + pt2temp.y + ", " + Main.project_zp(pt6[3], pt6[4], pt6[5]) + ", " + Main.project_phi + ", " + Main.project_theta);    // temporary code
                //}                                                           // END of temporary code
            }
            //System.out.println("final ," + i + ", " + pt6[3] + ", " + pt6[4] + ", " + pt6[5]);
        ...
        System.out.println("])");
        System.out.println("'''");
        System.out.println("final x_y_z , " + pt6[0] + ", " + pt6[1] + ", " + pt6[2]);
        ...
        if (Math.abs(M[0][0] + M[1][1]) < 2*eig)
        {
            ...
            System.out.println("'''");
            System.out.println("iT, Re_V21, Im_V21 = " + iT + ", " + Main.final_Re_V21 + ", " + Main.final_Im_V21);
//            System.out.println("summary, " + Main.a + ", " + Main.b + ", " + Main.c + ", " + eig + ", " + angle*180/Math.PI + ", " + Main.final_Re_V21 + ", " + Main.final_Im_V21 + ", " + Math.atan2(M[1][1] - M[0][0], M[0][1] + M[1][0])*180/Math.PI/2 + ", " + Math.sqrt((M[0][1] - M[1][0] + sqr)/(M[0][1] - M[1][0] - sqr)));
    ...
    private static void fit_cubic_response_full()
    {
        ...
        //System.out.println("first-order hdr = '" + first_order_hdr + "'");
        Main.skew_transform = true;             // make the linear response "uniform"
        double incr = 0.0007;     // 0.0001/2
        double[] pt6;
        int Nangl = 72;                         // # of angular positions (for radial grid)
        int Nrad = 5;                           // # of radii > 0 (for radial grid)
        int zsync = 1;
        ...
        for (int i = 1; i < Nrad + 1; i++)      // increment r' radius by i*incr
            for (int j = 0; j < Nangl; j++)     // increment angle by 360/Nposn degrees
            {
                ...
                // loop through one cycle
                for (int k = 0; k < Main.final_Period + zsync*100; k++) // add 10 iterations just to be sure it crosses (KEEP)
                {
                    Main.runge_kutta_chua6_ddu3_full(pt6, Main.final_delt);
                    //if (k + 1 == 24*1000)                       // temporary test code for in-flight response at k
                    //{
    ...
    private static void fit_cubic_response_full_3D()
    {
        ...
        System.out.println("cubic_hdr = \"\\n\\");
        System.out.println("Chua - Neimark-Sacker - measure cubic model 3-D response after one cycle\\n\\");
        System.out.println("incr_iT_eig_angle, " + incr + ", " + first_order_hdr + ", \\n\\");
        System.out.println("alpha_beta_gamma , " + Main.alpha + ", " + Main.beta + ", " + Main.gamma + ", " + Main.a + ", " + Main.c + ",\\n\\");
    ...
    private static void fit_cubic_response_full_radial()
    {
        // collect Chua oscillator data to fit full nonlinear response, after one cycle,
        // measure only radial response to a change in theta(x', y')  and z'.
        // assume that the output has already been made uniform, by running 'fit_linear_response()'
        // use 'Main.runge_kutta_chua6_ddu3_full' which leaves the original limit cycle unchanged
        ...
        System.out.println("\nPython output (fit_cubic_response_full w.r.t. theta and z'):");
        System.out.println("cubic_hdr = \"\\n\\");
        System.out.println("Chua - Neimark-Sacker - measure cubic model response after one cycle\\n\\");
        System.out.println("incr_iT_eig_angle, " + incr + ", " + first_order_hdr + ", \\n\\");
        System.out.println("alpha_beta_gamma , " + Main.alpha + ", " + Main.beta + ", " + Main.gamma + ", " + Main.a + ", " + Main.c + ",\\n\\");
        System.out.println("Period_delt      , " + Main.final_Period + ", " + Main.final_delt + ", " + Nangl + ", " + Nz + ",\\n\\");
        System.out.println("x_y_z            , " + Main.final_x + ", " + Main.final_y + ", " + Main.final_z + ",\\n\\");
        System.out.println("phi_theta_psi    , " + Main.project_phi + ", " + Main.project_theta + ", " + Main.project_psi + ",\\n\\");
        System.out.println("x'_y'_z'         , " + pt2.x + ", " + pt2.y + ", " + zp + ",\\n\\");
        System.out.println("\\n\\");
        System.out.println("Nz,Nangle,r,z',theta");
        System.out.print("data = np.array([");

        for (int i = -Nz; i < Nz + 1; i++)      // increment z' i*incr
            for (int j = 0; j < Nangl; j++)     // increment angle by 360/Nposn degrees
            {
                pt6 = new double[] {Main.final_x, Main.final_y, Main.final_z,
                                    incr*Main.invert_from_xp_yp(Math.cos(j*2*Math.PI/Nangl), Math.sin(j*2*Math.PI/Nangl), i, "x"),
                                    incr*Main.invert_from_xp_yp(Math.cos(j*2*Math.PI/Nangl), Math.sin(j*2*Math.PI/Nangl), i, "y"),
                                    incr*Main.invert_from_xp_yp(Math.cos(j*2*Math.PI/Nangl), Math.sin(j*2*Math.PI/Nangl), i, "z")};
                // loop through one cycle
                for (int k = 0; k < Main.final_Period; k++) // use t_sync only
                {
                    Main.runge_kutta_chua6_ddu3_full(pt6, Main.final_delt);
                }
                if (true)                        // use last point (synchronize in time)
